...
/**
 * 헤더/푸터 어디든 배치할 수 있는 "로그아웃" 버튼. (v3 — 표시 변경: 잠금 → 로그아웃 + 크기 확대)
 *
 * 클릭 시:
 ...
 *
 * [v2 → v3] 라벨을 "잠금" → "로그아웃"으로 변경하고, 화면 우측 하단에 있던
 * BuildMarker(build v10 표시)가 App.jsx에서 제거되면서 우측 하단이 비게 된
 * 점을 감안해 버튼 자체를 더 눈에 띄게 확대했습니다(아이콘/글자 크기, 여백,
 * 테두리·그림자 추가).
 */
